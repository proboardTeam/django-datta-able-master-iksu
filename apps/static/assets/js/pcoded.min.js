...
function menuhrres() {
  $(window)[0].innerWidth < 768
    ...
    : setTimeout(function () {
        ...
        .addClass("sidenav-horizontal-wrapper").removeClass(
          "sidenav-horizontal-wrapper-dis"
        ),
...
/*$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://appseed.us/" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> 경고 상황 살펴보기' +
    '</a> ' + '</div>' + '');
var $window = $(window);
