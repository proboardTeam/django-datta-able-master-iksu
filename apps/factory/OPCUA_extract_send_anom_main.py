...
def main():
    ...
    endtime = datetime.datetime.strptime("2022-04-26T04:21:31.448000+00:00", '%Y-%m-%dT%H:%M:%S.%f+00:00')
    starttime = datetime.datetime.strptime("2022-04-26T04:21:30.448000+00:00", '%Y-%m-%dT%H:%M:%S.%f+00:00')
    ...
    data2 = [{"values": values, "dates": dates}]
    print(f'data2 : {data2}')

    with open('C:/Users/user/Desktop/4월5주차 자료/current_accelerationPack_2.json', 'w') as json_file:
    ...
    for i in range(len(formatRanges)):
        ...
        plt.title("AccelerationPack[g] - before hpf")
        plt.show()

        with open('C:/Users/user/Desktop/4월5주차 자료/current_g_2.json', 'w') as json_file:
            json.dump({"data": data[i]}, json_file, indent=4)
            # data_list.append(data2)
        ...
        plt.xlabel('Time [s]')
        plt.ylabel('RMS Acceleration [g]')
        plt.title("AccelerationPack[g] - after hpf")
        plt.show()

        with open('C:/Users/user/Desktop/4월5주차 자료/current_hpf_2.json', 'w') as json_file:
    ...
    with open('C:/Users/user/Desktop/4월5주차 자료/current_data.json', 'w') as json_file:
