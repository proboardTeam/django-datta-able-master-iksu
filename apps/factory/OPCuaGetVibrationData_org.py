...
class HighPassFilter(object):
    ...
    @staticmethod
    def perform_hpf_filtering(data, sampleRate, hpf=3, order_1=2, order_2=2):
        if hpf == 0:
            return data
...
async def main():
    ...
    url: str = 'opc.tcp://25.9.7.151:4840/freeopcua/server'
    ...
    for i in range(len(formatRanges)):
        ...
        df.to_excel('C:/Users/user/Desktop/4월5주차 자료/2022-03-24T065052/vib_before_hpf_time.xlsx')

        with open('C:/Users/user/Desktop/4월5주차 자료/2022-03-24T065052/vib_before_hpf_time.json', 'w') as json_file:
        ...
        # df = pd.DataFrame({"Time_[s]": timeValues.tolist(), "accelerationPack": data[i]})
        # df.to_excel('C:/Users/user/Desktop/4월5주차 자료/2022-03-24T065052/vib_after_hpf_time.xlsx')
    #
    #     with open('C:/Users/user/Desktop/4월5주차 자료/2022-03-24T065052/vib_after_hpf_time.json', 'w') as json_file:
    ...
    #     df.to_excel('C:/Users/user/Desktop/4월5주차 자료/2022-03-24T065052/vib_after_hpf_frequency.xlsx')
    #
    #     with open('C:/Users/user/Desktop/4월5주차 자료/2022-03-24T065052/vib_after_hpf_frequency.json', 'w') as json_file:
