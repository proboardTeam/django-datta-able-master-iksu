...
def dataTrans():
    ...
    sensors.append(sensorInfo('25.52.52.52', "dksw5",'92:7c:bd:51', '83')) #(T_DK) Milling_Right_Vib_HighFQ 
    sensors.append(sensorInfo('25.52.52.52', "dksw6",'ce:42:0e:97', '83')) #(T_DK) Milling_Left_Vib_LowFQ 
    # sensors.append(sensorInfo('25.52.52.52', "dksw3",'4b:98:18:4d')) #(T_DK) Current_WeldingLeft
    # sensors.append(sensorInfo('25.52.52.52', "dksw4",'fb:cc:b1:63')) #(T_DK) Current_WeldingRight 
...
if __name__ == '__main__':   
    ...
    errors_solved = []
    dataTrans()
    schedule.every(60).minutes.do(dataTrans)
